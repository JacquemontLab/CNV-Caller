...
## 3- Mendelian precision across CNV length bins stratified by deletion and duplication types, two algorithm overlap thresholds, and filtering criteria (including segmental duplication exclusion and maximum confidence score), with error estimates and minimum count filtering.
